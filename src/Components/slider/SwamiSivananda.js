...
Satchidananda Saraswati, founder of the Integral Yoga Institutes, around the world[17]
Satyananda Saraswati, founder of Bihar School of Yoga[18]
...
Vishnudevananda Saraswati, founder of the Sivananda Yoga Vedanta Centres, HQ Canada</p>
      </div>
    </div>
  );
};

export default SwamiSivananda;
